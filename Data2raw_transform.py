...
def noise_data(images):
    for i in range(c):
        ...
        output.save(f'./data_set/Data2_noise/{i}.png')
...
if __name__ == '__main__':
    images_gif = gif_main(r'./data_set/Data2','data2.gif')
    noise_data(images_gif)
    noise_gif = gif_main(r'./data_set/Data2_noise','data2_noise.gif')
    figure_concat()
    concat_gif = gif_main(r'./data_set/Data2_concat','data2_concat.gif')
